/** biome-ignore-all lint/a11y/noStaticElementInteractions: needed for image trigger */
"use client";
					...
					<Dialog>
						<DialogTrigger asChild>
							<div
								...
								// biome-ignore lint/a11y/noNoninteractiveTabindex: is needed for keyboard accessibility as div is interactive
								tabIndex={0}
							/>
						</DialogTrigger>
						<DialogContent className="md:min-w-[80vw]">
							{selectedImage && (
								// biome-ignore lint/performance/noImgElement: using img for full size display
								<img
									src={selectedImage}
									alt="Full Size"
